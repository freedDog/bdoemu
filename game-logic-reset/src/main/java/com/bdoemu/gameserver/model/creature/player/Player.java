...
import com.bdoemu.core.configs.PlayerConfig;
...
//        this.sendPacketNoFlush(new SMVolunteerInfo());
...
//        this.sendPacketNoFlush(new SMSetWpp(this.getCurrentWp(), this.getBaseWp()));
