...
/**
 * @ClassName SiegeObjectDoingAction
 * @Description TODO
...
public class SiegeObjectDoingAction extends ADefaultAction {

    public SiegeObjectDoingAction(final ActionChartActionT actionChartActionT) {
