    ...
    public static Creature newCreature(final SpawnPlacementT spawnPlacement) {
        ...
        if (template != null) {
            switch (template.getCharKind()) {
                case Monster    :
                    creature = new Monster((int) GameServerIDFactory.getInstance().nextId(GSIDStorageType.Creatures), template, spawnPlacement);
                    break;
                case Npc        :
                    creature = new Npc    ((int) GameServerIDFactory.getInstance().nextId(GSIDStorageType.Creatures), template, spawnPlacement);
                    break;
                case Collect    :
                    creature = new Collect((int) GameServerIDFactory.getInstance().nextId(GSIDStorageType.Collect), template, spawnPlacement);
                    break;
                case Vehicle    :
                    creature = new Servant((int) GameServerIDFactory.getInstance().nextId(GSIDStorageType.Creatures), template, spawnPlacement);
                    break;
                case Alterego   :
                    creature = new Gate   ((int) GameServerIDFactory.getInstance().nextId(GSIDStorageType.Creatures), template, spawnPlacement);
                    break;
                default:
                    break;
            }
...
//        // TODO: Remove me after full rewrite of AI.
//        _aiScript = script;
//    }
