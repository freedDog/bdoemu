...
public class ObsceneFilterData extends XmlDataHolder {
    ...
    private static final List<BadWordSet> badWordSet;
    private static final List<String> badWordsCache;
            ...
            protected boolean read(final Node nNode) {
                ...
                new NodeForEach(nNode.getChildNodes()) {
                    ...
                    protected boolean read(final Node nNode) {
                        ...
                        final String nodeName = nodeName2 = nNode.getNodeName();
                        switch (nodeName2) {
                            case "equivalents": {
                                new NodeForEach(nNode.getChildNodes()) {
                                    @Override
    ...
    static {
        equivalents = new HashMap<String, String>();
        badWordSet = new ArrayList<BadWordSet>();
        badWordsCache = new ArrayList<String>();
    }

    private static class Holder
    {
        static final ObsceneFilterData INSTANCE;

        static {
            INSTANCE = new ObsceneFilterData();
        }
    }
}
