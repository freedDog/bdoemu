...
public class WaypointData extends XmlDataHolder {
    private static final Map<String, List<WaypointDataT>> waypoints;
    private static final Map<Integer, WaypointT> waypointsByKey;
    ...
    public WaypointT getWaypoint(final Integer[] waypointData) {
    ...
    static {
        waypoints = new HashMap<String, List<WaypointDataT>>();
        waypointsByKey = new HashMap<Integer, WaypointT>();
    }

    private static class Holder
    {
        static final WaypointData INSTANCE;
