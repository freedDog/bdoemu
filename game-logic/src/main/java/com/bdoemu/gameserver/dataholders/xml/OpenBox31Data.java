...
public class OpenBox31Data extends XmlDataHolder {
    ...
    public void loadData(final NodeList nList) {
        ...
        OpenBox31Data.log.info("Loaded {} box entries.", (Object)this.boxes.size());
    }

    static {
        log = LoggerFactory.getLogger((Class)OpenBox31Data.class);
    }

    private static class Holder
    {
        static final OpenBox31Data INSTANCE;

        static {
            INSTANCE = new OpenBox31Data();
        }
    }
}
